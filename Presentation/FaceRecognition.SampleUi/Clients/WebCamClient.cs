...
namespace FaceRecognition.SampleUi.Clients
{
    //https://raw.githubusercontent.com/secile/UsbCamera/master/UsbCamera.cs
    // [How to use]
    ...
    internal class WebCamClient
    {
        ...
        /// </param>
        public WebCamClient(int cameraIndex, Size size) : this(cameraIndex, new VideoFormat() { Size = size })
        {
        }
        ...
        /// </param>
        public WebCamClient(int cameraIndex, VideoFormat format)
        {
