...
namespace EmguComputerVision4.Tests
{
    [TestClass]
    public class FaceRecognitionTests
    {
        ...
        [TestMethod]
        public void GetFaceBitmapFromClassifiedImage_Pass()
        {
            var client = new FaceRecognitionClient(@"..\..\..\..\..\..\Resources\ComputerVision.Models\haarcascade_frontalface_default.xml");
            var originalBidenImage = client.GetClassifiedImage(new Bitmap(@"..\..\..\..\..\..\Resources\Tests.Data\images\biden.jpg"));

            var bidenFaceBitmap = client.GetFaceBitmapFromClassifiedImage(originalBidenImage);
            Assert.IsNotNull(bidenFaceBitmap);

            //var cropBidenImage = new Bitmap(@"..\..\..\..\..\..\Resources\Tests.Data\images\biden-100-cubic.bmp");
        }
