...
using Emgu.CV.Util;
using EmguComputerVision3.Configurations;
using EmguComputerVision3.Models;
...
namespace EmguComputerVision3
{
    public class FaceRecognitionClient : IFaceRecognitionClient
    {
        ...
        public Bitmap GetBitmapWithLocations(Bitmap bitmap)
        {
            ...
            var image = new Image<Gray, byte>(returnBitmap);
            ...
            {
                using (var p = new Pen(Color.DarkRed, returnBitmap.Width / 200f))
                {
